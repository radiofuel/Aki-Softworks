...
-- Tab page: previous canvas hides instantly; only the new page tweens in (fade + slide).
local PAGE_FADE_TIME = 0.57
local PAGE_SLIDE_PX = 18
local PAGE_IN_TWEEN_INFO = TweenInfo.new(PAGE_FADE_TIME, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
    ...
    function AeroWindow:Tab(Title, Image)
        ...
        function AeroTab:Enable()
            ...
            if animatePage then
                ...
                local inTween = TweenService:Create(PageLayer, PAGE_IN_TWEEN_INFO, {
                    GroupTransparency = 0,
                    Position = UDim2.new(0, 0, 0, 0)
                })
        ...
        function AeroTab:Disable()
            ...
            -- No outgoing tween — old page must not linger while the new tab animates in.
        ...
        function AeroTab:Section(Side, Title, Description)
            ...
            function AeroSection:Keybind(Title, Settings)
				...
				UserInputService.InputBegan:Connect(function(input, gpe)
                    ...
                    if input.KeyCode == Enum.KeyCode.Escape and Listening then
						Settings.Value = nil
